				...
				<table class="w640" border="0" cellpadding="0" cellspacing="0" width="640">
					...
					<tr class="mobile_only">
						<td class="w640" width="640" align="center">
							<img class="mobile_only" border="0" src="<?php echo e(array_key_exists('path', $logo) ? $logo['path'] : ''); ?>" alt="<?php echo e(isset($senderName) ? $senderName : ''); ?>" width="<?php echo e(array_key_exists('width', $logo) ? $logo['width'] : ''); ?>" height="<?php echo e(array_key_exists('height', $logo) ? $logo['height'] : ''); ?>" />
						</td>
					</tr>
					<tr class="mobile_only">
						<td class="w640" height="10" width="640"></td>
						...
						<td id="header" class="w640" align="center" bgcolor="#FFFFFF" width="640">
							<table class="w640" border="0" cellpadding="0" cellspacing="0" width="640">
								<tr>
									...
									<td id="logo" width="<?php echo e(array_key_exists('width', $logo) ? $logo['width'] : ''); ?>" valign="top">
...
<?php /**PATH C:\ProjectAkhirWeb\laravel-belajar-web\vendor\snowfire\beautymail\src\views\templates\ark.blade.php ENDPATH**/ ?>