<html xmlns="http://www.w3.org/1999/xhtml"><head>
	...
	<title></title>
	<style type="text/css"><?php echo e(file_get_contents(app_path() . '/../vendor/snowfire/beautymail/src/styles/css/minty.css')); ?></style>
	<?php if($css): ?>
	<style type="text/css">
		<?php echo e($css); ?>
...
<!--							If you cannot read this email, please  <a class="hlite" href="#" style="text-decoration: none; color: <?php echo e(Config::get('beautymail.colors.highlight', '#004cad')); ?>">click here</a>-->
						</td>
					</tr>
					<!-- Spacing -->
					<tr>
...
<div class="block">
	...
	<table width="100%" bgcolor="#f6f4f5" cellpadding="0" cellspacing="0" border="0" id="backgroundTable" st-sortable="header">
		...
		<tr>
			<td>
				<table width="580" bgcolor="<?php echo e(Config::get('beautymail.colors.highlight', '#004cad')); ?>" cellpadding="0" cellspacing="0" border="0" align="center" class="devicewidth" hlitebg="edit" shadow="edit">
					<tbody>
					<tr>
						<td>
							<!-- logo -->
							<table width="280" cellpadding="0" cellspacing="0" border="0" align="left" class="devicewidth">
								...
								<tr>
									<td valign="middle" width="270" style="padding: 10px 0 10px 20px;" class="logo">
										<div class="imgpop">
											<a href="#"><img src="<?php echo e(array_key_exists('path', $logo) ? $logo['path'] : ''); ?>" alt="<?php echo e(isset($senderName) ? $senderName : ''); ?>" width="<?php echo e(array_key_exists('width', $logo) ? $logo['width'] : ''); ?>" height="<?php echo e(array_key_exists('height', $logo) ? $logo['height'] : ''); ?>" border="0" style="display:block; border:none; outline:none; text-decoration:none;" st-image="edit" class="logo"></a>
										</div>
									</td>
								</tr>
								</tbody>
...
<?php /**PATH C:\ProjectAkhirWeb\laravel-belajar-web\vendor\snowfire\beautymail\src\views\templates\minty.blade.php ENDPATH**/ ?>