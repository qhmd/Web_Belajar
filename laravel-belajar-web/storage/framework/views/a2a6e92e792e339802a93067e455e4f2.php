	...
	<tr>
		...
		<td width="100%" bgcolor="#ffffff">
			...
			<table width="100%" cellpadding="20" cellspacing="0" border="0">
				<tr>
					<td bgcolor="#ffffff" class="contentblock"><?php /**PATH C:\ProjectAkhirWeb\laravel-belajar-web\vendor\snowfire\beautymail\src\views\templates\widgets\articleStart.blade.php ENDPATH**/ ?>