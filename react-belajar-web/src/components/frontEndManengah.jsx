    ...
    useEffect(() => {
        axios.get("http://127.0.0.1:8000/materifront") // URL API Laravel
            .then((response) => {
                ...
                const materiPemula = response.data.filter(materi => materi.level_materi === 'Manengah');
        ...
        <div className="relative min-h-screen bg-gradient-to-br from-black via-[#0f172a] to-blue-800">
            ...
            <div className="relative z-20 container mx-auto max-w-full px-4">
                <div className='flex items-center justify-center h-20'>
                    <h1 className="text-2xl font-bold text-center text-white">Daftar Materi Front-End Menengah</h1>
                </div>
...
export default FrontEndUserMenengah;
