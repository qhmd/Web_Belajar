...
const navigation = [
  ...
  { name: 'Fullstack', href: '/full-stack' },
];
...
const Header = () => {
  ...
  return (
    <div className="overflow-auto">
      <Toaster />
      <header className="absolute bg-blue-800 inset-x-0 top-0 z-50 border">
        <nav className="flex items-center justify-around p-6 lg:px-8">
          ...
          <Menu as="div" className="relative inline-block text-left">
            ...
            {/* Hapus 'static' dari MenuItems */}
            <MenuItems
              className="absolute -right-24 z-10 mt-2 w-56 origin-top-right rounded-md bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none"
            >
              <div className="py-1">
                <div className="px-4 py-2 text-gray-700">
                  {/* Pengecekan user.name sebelum mengaksesnya */}
