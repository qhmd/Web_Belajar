    ...
    useEffect(() => {
        axios.get("http://127.0.0.1:8000/materifront") // URL API Laravel
            .then((response) => {
                ...
                const materiLanjutan = response.data.filter(materi => materi.level_materi === 'Ahli');
                setMateri(materiLanjutan); // Menyimpan hasil filter ke state
            })
            .catch((error) => {
        ...
        <div className="relative min-h-screen bg-gradient-to-br from-black via-[#0f172a] to-blue-800">
            ...
            <div className="relative z-20 container mx-auto max-w-full px-4">
                <div className='flex items-center justify-center h-20'>
                    <h1 className="text-2xl font-bold text-center text-white">Daftar Materi Front-End Lanjutan</h1>
                </div>
...
export default FrontEndUserLanjutan;
